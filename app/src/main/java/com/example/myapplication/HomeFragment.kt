...
class HomeFragment : Fragment() {
    ...
    private val filmsDataBase = listOf(
        ...
        Film("Parasites", R.drawable.parasites, "Greed and class discrimination threaten the newly formed symbiotic relationship between the wealthy Park family and the destitute Kim clan.",5.7f),
